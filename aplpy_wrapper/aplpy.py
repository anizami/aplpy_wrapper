...
class FITSFigure(Layers, Regions, Deprecated):
    ...
    def __init__(self, data, hdu=0, figure=None, subplot=(1, 1, 1),
        ...
        # TODO: remove this because it's already stored in WCSAxes instance
        # Store WCS in axes
    ...
    def show_lines(self, line_list, layer=False, zorder=None, **kwargs):
        ...
        kwargs
            ...
            or linewidth) are passed to Matplotlib
            :class:`~matplotlib.collections.LineCollection` class, and can be
            used to control the appearance of the lines.
        '''
    ...
    def add_label(self, x, y, text, relative=False, color='black',
        ...
        common: color, family, style, variant, stretch, weight, size,
                fontproperties, horizontalalignment, verticalalignment
        '''
    ...
    def save(self, filename, dpi=None, transparent=False, adjust_bbox=True,
        ...
        # TODO: Figure out all this stuff
        artists = []
        if adjust_bbox:
